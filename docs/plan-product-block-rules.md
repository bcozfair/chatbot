...
มีคอมเมนต์กำกับที่ field ว่าห้ามเอากลับมาใช้ตัดสิน และจะลบพร้อมคอลัมน์ในเฟส 5
...
- **ยังส่ง `is_locked` ค่าเดิมกลับไปตอนบันทึก** — ไม่งั้นแอดมินแก้กฎหนึ่งครั้งแล้วค่าใน DB ถูกล้าง
  ทำให้เทียบของเก่ากับของใหม่ระหว่าง soak ไม่ได้ (`diag:block-parity` ใช้ค่านี้) ลบพร้อมคอลัมน์ในเฟส 5
