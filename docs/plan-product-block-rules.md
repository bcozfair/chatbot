...
> **สถานะ: ✅ ทำครบทั้ง 5 เฟสแล้ว — ขึ้น production วันที่ 2026-09-07**
> สำรวจจากโค้ดจริง 2026-09-03 · เอกสารนี้เปลี่ยนสถานะจาก "แผน" เป็น "บันทึกของที่ทำจริง"
> อ่านต่อได้เหมือนเดิม — แต่ละเฟสมีป้าย ✅ กำกับ และส่วนที่ทำจริงต่างจากที่ร่างไว้ถูกเขียนทับด้วยของจริงแล้ว
>
> | เฟส | สถานะ |
> | --- | --- |
> | 1 — rule engine 5 ระดับ | ✅ |
> | 2 — ตาราง `product_block_rules` + ย้ายข้อมูล | ✅ |
> | 3 + 3.5 — สลับจุดบล็อก + ข้อความทรง MOQ | ✅ |
> | 4 — หน้าแอดมิน "บล็อกสินค้า" | ✅ |
> | 5 — ลบ `quotation_rules.is_locked` | ✅ |
>
> ของที่เจอหลัง deploy จริงและแก้ไปแล้ว: §5.6 (`model` ติดช่องว่างจาก Odoo หลุดด่าน)
> ของที่ยังเปิดอยู่: §8 ตารางความเสี่ยง (เหลือเฉพาะข้อที่จงใจไม่ทำ) และ §9
...
| ~~ถ้อยคำร่างของ 4 กฎเดิมไม่ตรงเหตุผลธุรกิจจริง~~ | ปิดแล้ว | ผู้ใช้ยืนยันข้อความทั้ง 8 แถวใช้ตามที่เป็นอยู่ (2026-09-07) · แก้ทีหลังผ่านหน้าแอดมินเฟส 4 ได้ตลอด |
