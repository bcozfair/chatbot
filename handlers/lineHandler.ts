  ...
  try {
    ...
    if (event.message.type === 'text' && content) {
      ...
      const prompt = `
        ...
        8. หากเซลส์พิมพ์ชื่อมาเพียงชื่อเดียว (เช่น บรรทัดที่สองหลังจากเสนอราคา หรือระบุมาสั้นๆ) ให้วิเคราะห์ว่าเป็นชื่อบุคคล/ผู้ติดต่อ หรือเป็นชื่อบริษัท/ห้างร้าน (สังเกตจากคำขึ้นต้น/ลงท้าย หรือลักษณะของชื่อภาษาไทย เช่น 'อธิชาต' หรือ 'คุณถาวร' หรือ 'สมพร' เป็นชื่อผู้ติดต่อ ให้ใส่ in contact_query และเว้น customer_query เป็น null, ส่วน 'เคซีอี', 'ซีเคซี' เป็นชื่อบริษัท ให้ใส่ใน customer_query และเว้น contact_query เป็น null)
        ...
        14. แยกแยะชื่อบริษัท ("customer_query") และชื่อผู้ติดต่อ ("contact_query") โดยใช้คำขึ้นต้นเป็นเบาะแส เช่น:
            ...
            - ชื่อที่มีคำนำหน้าบุคคล เช่น "คุณ", "นาย", "นาง", "นางสาว" ให้วิเคราะห์เป็นชื่อผู้ติดต่อ ("contact_query")
