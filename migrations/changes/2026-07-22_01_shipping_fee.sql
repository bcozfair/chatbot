...
--
--  ลูกค้าที่ customer_payment_terms ไม่ได้เป็นรูปแบบ "<เลข> Days" หรือ
--  "เช็คล่วงหน้า<เลข>วัน" (เช่น Cash / NULL / Immediate Payment) ถือว่า "ไม่มีเครดิต"
--  — ถ้ายอดสินค้าก่อน VAT (หลังหักส่วนลด) รวมทุกใบ < เกณฑ์ ระบบจะเติมบรรทัดค่าขนส่งให้เอง
--
